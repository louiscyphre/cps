...
public class CustomerMainMenuControllerMk2 implements ViewController {
  ...
  void handleEnterParkingButton(ActionEvent event) {
    // TODO ControllersClientAdapter.setStage(ControllerConstants.SceneCode.ENTER_PARKING);
  }

  @FXML
  void handleExitParkingButton(ActionEvent event) {
    // TODO ControllersClientAdapter.setStage(ControllerConstants.SceneCode.EXIT_PARKING);
  }

  @FXML
  void handleViewMyReservationsButton(ActionEvent event) {
    // TODO ControllersClientAdapter.setStage(ControllerConstants.SceneCode.VIEW_MY_REGISTRATIONS);
  }
  ...
  void handleParkNowButton(ActionEvent event) {
    // TOD ControllersClientAdapter.setStage(ControllerConstants.SceneCode.INCIDENTAL_PARKING);
  }
  ...
  void initialize() {
      ...
      ControllersClientAdapter.registerCtrl(this, ControllerConstants.SceneCode.CUSTOMER_INITIAL_MENU_MK2);
