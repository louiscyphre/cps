...
public class ParkingLot implements Serializable {
	 ...
	 * float price1, float price2) { super(); this.id = id; this.streetAddress =
	 * streetAddress; this.size = size; this.content = content; this.price1 =
	 * price1; this.price2 = price2; }
	 * 
	 * public ParkingLot(ResultSet rs) throws SQLException { this(rs.getInt(1),
	 * rs.getString(2), rs.getInt(3), rs.getString(4), rs.getFloat(5),
	 * rs.getFloat(6)); }
	 */
