...
public class RegularSubscriptionRequest extends SubscriptionRequest {
  ...
  public RegularSubscriptionRequest(int customerID, String email, String[] carIDs, LocalDate startDate, int lotID, LocalTime dailyExitTime) {
   ...
   * @param lotID the lot ID
   * @param dailyExitTime the daily exit time */
  public RegularSubscriptionRequest(int customerID, String email, String carID, LocalDate startDate, int lotID, LocalTime dailyExitTime) {
